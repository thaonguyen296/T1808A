            ...
            <table class="table">
                ...
                @foreach($bills as $bill)
                    <tr class="odd">
                        ...
                        <td class="text-center"><span class="status_paid" @if($bill->payment != 1 && $bill->tracking->status != 4)style="color: red;" @endif> paid </span></td>
                        <td class="text-center"><span class="status_fulfilled" @if($bill->tracking->status != 4) style="color: red;"  @endif>fulfilled</span></td>
