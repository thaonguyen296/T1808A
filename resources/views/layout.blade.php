    ...
    <header class="header_area">
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    <a class="navbar-brand logo_h" href="{{url('/home')}}"><img src="{{URL::asset('img/logo.png')}}" alt=""></a>
...
{{--                                    <li class="nav-item"><a class="nav-link" href="{{url('/category')}}">Books</a></li>--}}
{{--                                    <li class="nav-item"><a class="nav-link" href="{{url('/category2')}}">Publication</a></li>--}}
{{--                                    <li class="nav-item"><a class="nav-link" href="{{url('/checkout')}}">Requisite</a></li>--}}
{{--                                    <li class="nav-item"><a class="nav-link" href="{{url('/confirmation')}}">School Supplies</a></li>--}}
{{--                                    <li class="nav-item"><a class="nav-link" href="{{url('/cart')}}">Other products</a></li>--}}
{{--                                </ul>--}}
                            </li>
{{--                            <li class="nav-item">--}}
{{--                                <a href="{{url('/blog')}}" class="nav-link"  >Blog</a></li>--}}
{{--                                <ul class="dropdown-menu">--}}
{{--                                    <li class="nav-item"><a class="nav-link" href="{{url('/')}}blog">Blog</a></li>--}}
{{--                                    <li class="nav-item"><a class="nav-link" href="{{url('/')}}single-blog">Blog Details</a></li>--}}

{{--                                    <li class="nav-item"><a class="nav-link" href="{{url('/')}}register">Register</a></li>--}}
{{--                                    <li class="nav-item"><a class="nav-link" href="{{url('/')}}tracking-order">Tracking</a></li>--}}
{{--                                </ul>--}}
        ...
        function addToCart(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    // alert('You have added 1 product to your cart!');
                },
